...
//       if (showCountryVariations && countryVariations) {
...
//       setMainCountry('');
//       setIdiom('');
//       setShowCountryVariations(false);
...
//   };
  ...
  // const handleShowCountryVariationsAlert = () => {
  //   setShowCountryVariations(true);
  // };
...
//         multiline
//       />
//       <TouchableOpacity style={styles.button} onPress={handleShowCountryVariationsAlert}>
...
//               {/* Add other English countries here */}
//             </Picker>
//           )}
...
//               {/* Add other Spanish-speaking countries here */}
//             </Picker>
//           )}
...
//               <Picker
//                 selectedValue={variation.language}
//                 onValueChange={(itemValue) => {
//                   const updatedVariations = [...countryVariations];
//                   updatedVariations[index].language = itemValue;
//                   setCountryVariations(updatedVariations);
//                 }}
//               >
//                 <Picker.Item label="Select Language" value="" />
